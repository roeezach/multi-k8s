...
kubectl set image deployments/client-deployment client=roeezach/multi-client:$SHA
kubectl set image deployments/worker-deployment worker=roeezach/multi-worker:$SHA
